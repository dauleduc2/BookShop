        ...
        <body>
                <div class="bg-white">
                        <div class="max-w-2xl px-4 py-16 mx-auto sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
                                <!-- Product details -->
                                <div class="flex flex-col flex-col-reverse sm:flex-row">
                                        <div class="lg:max-w-lg lg:self-end">
                                                ...
                                                <section aria-labelledby="information-heading" class="mt-4">
                                                        ...
                                                        <div class="flex items-center">
                                                                <p class="text-lg text-gray-900 sm:text-xl">$${requestScope.product.getPrice()}</p>
                                                        </div>

                                                        <div class="mt-4 space-y-6">
                                                                <p class="text-base text-gray-500">${requestScope.product.getDescription()}</p>
                                                        </div>
