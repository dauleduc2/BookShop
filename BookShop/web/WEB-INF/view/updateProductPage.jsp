...
<html>
        ...
        <body class="min-h-screen bg-gradient-to-b from-gray-200 to-gray-300">
                ...
                %>
                <form action="<%=Router.UPDATE_PRODUCT_CONTROLLER%>?productId=${requestScope.product.getProductId()}" method="POST"  class="max-w-2xl p-2 m-auto my-5 space-y-8 bg-white border-2 border-black divide-y divide-gray-200 rounded-md lg:p-7">
