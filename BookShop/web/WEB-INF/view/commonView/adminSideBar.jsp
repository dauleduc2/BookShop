    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      ...
      <nav class="flex-1 px-2 mt-5 space-y-1">
        <a
          ...
          class="flex items-center px-2 py-2 text-sm font-medium text-white rounded-md  hover:bg-gray-900 group"
        >
          <svg
        ...
        <a
          href="<%= Router.ADMIN_VIEW_PRODUCT_CONTROLLER%>?limit=10&page=1"
          class="flex items-center px-2 py-2 text-sm font-medium text-white rounded-md  hover:bg-gray-900 group"
        >
          <svg
            class="flex-shrink-0 w-6 h-6 mr-3 text-white"
