<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> <%@page contentType="text/html" pageEncoding="UTF-8"%> <% String avatarUrl = (String) session.getAttribute("avatarUrl");%> <%@page import="constant.Router"%>
                                ...
                                <c:choose>
                                    <c:when test="${avatarUrl != null}">
								     ...
								     ? "asset/images/avatar.png" : avatarUrl%>" alt="" />
                                                ...
                                                <div
                                                    class="absolute right-0 z-50 hidden w-48 mt-2 overflow-hidden origin-top-right bg-white rounded-md shadow-lg  ring-1 ring-black ring-opacity-5 focus:outline-none dropdownMenu"
                                                    role="menu"
