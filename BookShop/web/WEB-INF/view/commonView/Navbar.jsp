                                ...
                                <c:choose>
                                                ...
                                                <div
                                                    ...
                                                    >
                                                        ...
                                                        <a
                                                            ...
                                                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-700 hover:text-white transition duration-300"
                                                            role="menuitem"
                                                            tabindex="-1"
                                                            id="user-menu-item-0"
                                                            >Your Profile</a
                                    ...
                                    <c:otherwise>
                                        <div class="hidden sm:block">
                                                <a
                                                    class="inline-flex items-center px-3 py-2 mr-4 text-sm font-medium leading-4 text-gray-700 bg-white border border-gray-300 rounded shadow-sm cursor-pointer  hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<%=Router.LOGIN_CONTROLLER%>"
                                                    >
                                                        Sign In
                                                </a>
                                                <a
                                                    class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white rounded shadow-sm cursor-pointer  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<%=Router.REGISTER_CONTROLLER%>">
                                                        Sign Up
                                                </a>
                                        </div>
                                    </c:otherwise>
